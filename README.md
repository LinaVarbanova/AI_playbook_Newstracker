[README.md](https://github.com/user-attachments/files/27546163/README.md)
# AI News Tracker
...
```bash
cd ai-news-tracker
bash scripts/install.sh        # creates venv + installs deps + init DB
